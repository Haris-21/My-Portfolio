    ...
    return(
        ...
        <div className="w-full flex justify-center items-center pt-[4rem] pb-[4rem]">
            <div className="2xl:w-[80%] lg:w-[95%] xl:w-[90%] md:w-[90%] sm:w-[90%] xs:w-[90%] 2xs:w-[90%] 3xs:w-[90%] font-sans flex flex-col items-center">
                ...
                <p className="text-zinc-400 2xl:text-3xl xl:text-3xl lg:text-3xl md:text-3xl sm:text-3xl xs:text-md 2xs:text-md 3xs:text-md text-center">I've been working on Software Development for these years. Here's a timeline of my journey.</p>
